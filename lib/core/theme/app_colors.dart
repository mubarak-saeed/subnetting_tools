...
/// Primitive Color Tokens — Raw design values.
///
/// Do NOT use these directly in widgets.
/// Access semantic colors via [Theme.of(context).colorScheme]
/// and feature-specific colors via [AppThemeExtension].
abstract class AppColors {
  ...
  // ─── Semantic Status (raw values only) ─────────────────────────
