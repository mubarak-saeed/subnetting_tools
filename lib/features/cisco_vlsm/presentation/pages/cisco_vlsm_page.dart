    ...
    setState(() {
      ...
      if (_allocations.isNotEmpty) {
        HistoryStorage.addHistoryEntry(
          HistoryEntry(
            title: 'Cisco VLSM ($baseIp/$_baseCidr)',
            details: 'Allocated ${_allocations.length} subnets according to CCNA rules.',
            featureType: 'Cisco VLSM',
          ),
        );
      }
    });
              ...
              Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        'Cisco VLSM (${_allocations.length}):',
